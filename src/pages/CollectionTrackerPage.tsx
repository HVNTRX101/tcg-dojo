          ...
          <div className="max-w-7xl mx-auto">
            <div className="bg-blue-50 border border-blue-200 rounded p-4">
              ...
              <p className="text-gray-700 mb-3">
                The Collection Tracker is in &quot;BETA TEST&quot; mode. To report a bug please send
                us feedback here
              </p>
              <p className="text-gray-700 mb-3">
                Please let us know the Browser and version you are using along with the issue(s) you
                experienced. Feel free to include screenshots of the error as well!
              </p>
              <p className="text-gray-700 mb-3">
                Thank you for the feedback you have been giving us during the beta phase of this
                project. Please continue to send us feedback on the Collection Tracker
              </p>
                        ...
                        <td colSpan={8} className="p-12 text-center text-gray-500">
                          <div className="space-y-4">
                            ...
                            <ul className="text-left max-w-2xl mx-auto space-y-2">
                              ...
                              <li>
                                • Instantly view the high, mid and low values of your entire
                                collection across multiple games
                              </li>
                              <li>
                                • Share your haves, wants and trades across multiple platforms such
                                as our store, content site and our mobile affiliates (coming soon!)
                              </li>
                              <li>
                                • The Collection Tracker allows you to quickly track your gaming
                                inventory by allowing easy hit and search function, product pages,
                                and more. Simply click &quot;Add Products to Collection&quot; above
                                and begin your collection - (View Full FAQ)
                              </li>
                            </ul>
                          </div>
                        </td>
