...
const popularGames = [
  { name: 'Magic: The Gathering', gameKey: 'Magic: The Gathering' as const },
  { name: 'Yu-Gi-Oh!', gameKey: 'Yu-Gi-Oh!' as const },
  { name: 'Pokémon', gameKey: 'Pokemon' as const },
  { name: 'Disney Lorcana', gameKey: 'Disney Lorcana' as const },
  { name: 'One Piece', gameKey: 'One Piece' as const },
  { name: 'Digimon', gameKey: 'Digimon' as const },
];
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-background">
      ...
      <div className="bg-white dark:bg-card border-b border-gray-200 dark:border-border">
        <div className="max-w-7xl mx-auto px-6 py-8">
          <h1 className="text-3xl mb-2 text-foreground">More Products & Options</h1>
        ...
        <section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {popularGames.map((game, index) => (
              ...
              >
                <ImageWithFallback
                  src={generateCardPlaceholder(game.name, game.gameKey, 'Game')}
                  alt={game.name}
          ...
          <Card className="overflow-hidden bg-gradient-to-r from-blue-600 to-purple-600 text-white p-8 md:p-12">
            <div className="max-w-2xl">
              ...
              <p className="text-lg mb-6 text-white/90">
                TCG Dojo Gift Cards are the perfect gift for any trading card game enthusiast.
