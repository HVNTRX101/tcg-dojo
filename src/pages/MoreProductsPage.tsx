...
const popularGames = [
  { name: 'Magic: The Gathering', image: 'https://images.unsplash.com/photo-1644007824843-37e9069834bd?w=300' },
  { name: 'Yu-Gi-Oh!', image: 'https://images.unsplash.com/photo-1674106890436-368ce68342f1?w=300' },
  { name: 'Pokémon', image: 'https://images.unsplash.com/photo-1664997296099-5a0b63ab0196?w=300' },
  { name: 'Disney Lorcana', image: 'https://images.unsplash.com/photo-1542393545-10f5cde2c810?w=300' },
  { name: 'One Piece', image: 'https://images.unsplash.com/photo-1578632292335-df3abbb0d586?w=300' },
        ...
        <section>
          <Card className="p-8 text-center bg-gray-100">
            ...
            <p className="text-gray-600 mb-6">
              Contact our customer support team and we'll help you find the perfect cards or supplies.
            </p>
