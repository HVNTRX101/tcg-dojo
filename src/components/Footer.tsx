    ...
    <footer className="bg-gray-900 text-gray-300 mt-16">
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="border-t border-gray-800 pt-8 text-xs text-gray-500 space-y-4">
          <p>
            All rights reserved. All trademarks are property of their respective owners in the US
            and other countries. Some geospatial data on this website is provided by geonames.org.
            ...
            their respective companies. This website is not produced by, endorsed by, supported by,
            or affiliated with these card game companies.
          </p>
          <p>
            Magic: The Gathering®, the mana symbols, the tap symbol and all other related images
            are owned by Wizards of the Coast®. Yu-Gi-Oh!® and all related images are owned by
            Konami Digital Entertainment®. Pokémon® and all related images are owned by
            Nintendo®. Cardfight!! Vanguard and Weiss Schwarz are trademarks or registered
            trademarks of Bushiroad Inc. Wizards of the Coast, Konami Digital Entertainment,
            Nintendo, and Bushiroad are not affiliated with, endorsed, sponsored, or specifically
            approved by TCGplayer, and TCGplayer assumes no responsibility for any content or
            materials provided by these companies.
          </p>
          <p className="text-sm">©2025 TCGplayer, Inc. All Rights Reserved.</p>
          <div className="flex gap-4">
            <a href="#" className="hover:text-white">
              Privacy Policy
            </a>
